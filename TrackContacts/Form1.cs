 ...
 * Author: Eisha Aqeel
 * Date: March 25, 2022
 * Description: This is a contact tracing application using C#.
 * It displays a list of contacts and allow the user to add new peoples contacts to the list 
 * as well as edit existing contacts selected from a ListView.
 */
